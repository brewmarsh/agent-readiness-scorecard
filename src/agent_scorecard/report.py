...
def _generate_acl_section(stats: List[FileAnalysisResult]) -> str:
...
def _generate_type_safety_section(stats: List[FileAnalysisResult]) -> str:
...
def _generate_prompts_section(stats: List[FileAnalysisResult]) -> str:
...
def _generate_file_table_section(stats: List[FileAnalysisResult]) -> str:
...
def generate_markdown_report(stats: List[FileAnalysisResult], final_score: float, path: str, profile: Dict[str, Any], project_issues: Optional[List[str]] = None) -> str:
...
def generate_advisor_report(stats: List[AdvisorFileResult], dependency_stats: Dict[str, int], entropy_stats: Dict[str, int], cycles: List[List[str]]) -> str:
...
def generate_recommendations_report(results: Union[AnalysisResult, List[FileAnalysisResult]]) -> str:
