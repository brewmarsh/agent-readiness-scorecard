...
def generate_markdown_report(
    ...
    """Orchestrates the generation of the Markdown report using modular components."""
    ...
    # Quiet mode support from verbosity settings
    if verbosity == "quiet":
        return summary + "\n---\n*Generated by Agent-Scorecard*"

    # Delegation to modular report sections for better maintenance
    targets = generate_acl_section(stats, thresholds)
    types_section = generate_type_safety_section(stats, thresholds, verbosity)
    prompts = generate_prompts_section(stats, thresholds, project_issues)
    table = generate_file_table_section(stats, verbosity)
            ...
            recommendations.append(
                {
                    ...
                    # Beta branch logic: specific refactoring advice
