...
def _generate_acl_section(
    ...
    top_acl = sorted(all_functions, key=lambda x: cast(float, x.get("acl", 0)), reverse=True)[:10]
...
def generate_markdown_report(
    ...
    actual_thresholds: Thresholds = thresholds or cast(Thresholds, DEFAULT_THRESHOLDS.copy())
