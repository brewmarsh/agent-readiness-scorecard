...
from src.agent_scorecard import analyzer
...
def test_score_file_logic(tmp_path: Path):
    ...
    # RESOLUTION: score_file returns (score, details_string)
    score, issues = score_file(str(py_file), profile)
