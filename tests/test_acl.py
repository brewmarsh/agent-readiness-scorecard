...
def test_scoring_with_acl_penalty(tmp_path: Path) -> None:
    ...
    # This specifically targets the logic-depth aspect of Agent Physics.
    ...
    # Indentation must match the 24 spaces of level 6 to maintain Python syntax validity
    for i in range(320):
        content += f"                        x = {i}\n"
    ...
    # Math:
    # Depth = 5
    # CC = 6 (Function definition + 5 If statements)
    # LOC = ~327
